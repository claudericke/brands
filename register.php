        ...
        <div class="container">
            ...
            <form class="registerForm" method="post" name="RegistrationForm">
                ...
                <div class="twelve columns">
                    ...
                    <br/>
                    <input type="checkbox" name="preferedCorrespondence" value="Post" />&nbsp;Post
                    <p>WOULD YOU LIKE TO SUBSCRIBE TO OUR MAGAZINE</p>
                    <input type="checkbox" name="magazineSubscription" value="Yes" />&nbsp;Yes
                    <br/>
                    <input type="checkbox" name="magazineSubscription" value="eMail" />&nbsp;No
                    <br/>
                </div>
                <div class="twelve columns">
                    ...
                    <input type="checkbox" name="thirdPartMarketing" value="MobilePhone" />&nbsp;Mobile Phone (Voice and SMS)
                    <br/>
                    <input type="checkbox" name="thirdPartMarketing" value="eMail" />&nbsp;Yes&nbsp;
                    <input type="checkbox" name="thirdPartMarketing" value="Post" />&nbsp;No
                    <br />
                </div>
                <br/>
                <br/>
