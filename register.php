                        ...
                        <div class="container">
                            ...
                            <form class="registerForm" method="post" name="RegistrationForm">
                                ...
                                <div class="twelve columns">
                                    ...
                                    <br/>
                                    <input type="checkbox" name="magazineSubscription" value="No" />&nbsp;No
                                    <br/>
                                </div>
                                <div class="twelve columns">
                                    ...
                                    <input type="checkbox" name="thirdPartMarketing" value="Yes" />&nbsp;Yes&nbsp;
                                    <input type="checkbox" name="thirdPartMarketing" value="No" />&nbsp;No
                                    <br />
                                </div>
                                <br/>
                                <br/>
