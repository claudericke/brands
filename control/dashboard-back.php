    ...
    <div class="wrapper">
        <div class="container">
            <div class="row header">
                <div class="eight columns"><img src="images/logo.png" />
                </div>
                <div class="two columns "><a href="settings.html" class="settings_btn">Settings</a> </div>
                <div class="two columns "><a href="login-back.html" class="login_btn">Log Off</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="three columns sidebar">
                    <ul class="user_profile">
                        <li class="user_image"><img src="images/user.png" />
                        </li>
                        <li>
                    ...
                    <nav>
                        ...
                        <div id="acdnmenu" class="">
                            <ul class="nav accordion">
                                ...
                                <li id="v_hm" class="menu_item stats_icon"><a href="#">Statistics</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="offset-by-four five columns">
            <p class="center small">©2001–
                <?php echo date( "Y"); ?> All Rights Reserved. Brands ® is a registered trademark of Massive Dynamics.
                <br />
                <a href="../terms.html">Privacy and Terms</a>
            </p>
        </div>
    </div>
    </div>
